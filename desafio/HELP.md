...
* [Rest Repositories](https://docs.spring.io/spring-boot/docs/3.0.0/reference/htmlsingle/#howto.data-access.exposing-spring-data-repositories-as-rest)
...
```
$ docker run --rm desafio:0.0.1-SNAPSHOT
```
